...
impl SkyboxPass {
    pub fn new(
        ...
        let render_node = RenderNode::builder()
            .set_vertex_shader(VertexShader::new("src/shader_files/vs_skybox.shader")?)
            .set_fragment_shader(FragmentShader::new("src/shader_files/fs_skybox.shader")?)
            .add_shared_uniform_bind_group(global_unifroms[0])
