...
//     result += light.specular * intensity * spec * texture(material.specular_textures[i], texCoords).rgb;
//     result *= attenuation;
//     result += light.diffuse * intensity * diff * texture(material.diffuse_textures[i], texCoords).rgb;
//     result *= attenuation;
//     result +=  light.ambient * texture(material.diffuse_textures[i], texCoords).rgb;
